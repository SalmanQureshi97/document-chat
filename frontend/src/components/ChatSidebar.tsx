...
export function ChatSidebar({
	...
	return (
		<div className="flex h-full w-[300px] flex-shrink-0 flex-col border-r border-neutral-200 bg-white">
									...
									<div className="min-w-0 flex-1 pr-2 overflow-hidden">
										...
										<div className="mt-0.5 flex items-center gap-1.5">
											...
											{conversation.document_count > 0 && (
												<span className="inline-flex items-center rounded-full bg-neutral-100 px-1.5 py-0 text-[10px] font-medium leading-4 text-neutral-500">
