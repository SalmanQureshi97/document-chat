...
interface ChatWindowProps {
	...
	// IDs of assistant messages currently being judged — drives the
	// "Verifying…" skeleton in MessageBubble.
	judgingMessageIds: Set<string>;
				...
				<div className="mx-auto max-w-2xl space-y-1">
					{messages.map((message) => (
						<MessageBubble
							...
							judging={judgingMessageIds.has(message.id)}
						/>
					))}
